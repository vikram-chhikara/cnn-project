...
#INITIAL_LEARNING_RATE = 0.01       # Initial learning rate. Slightly lower
# INITIAL_LEARNING_RATE = 0.001       # Initial learning rate. Even lower
...
def inference(images):
  ...
  with tf.variable_scope('local4') as scope:
    ...
    #local4 = tf.nn.elu(tf.matmul(reshape, weights) + biases, name=scope.name)
...
def train(total_loss, global_step):
  ...
  with tf.control_dependencies([loss_averages_op]):
    #Analysis with two different optimizers
